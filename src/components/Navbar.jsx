...
import { CircuitBoard, LogIn, LogOut, LayoutDashboard, Upload, Users, X } from 'lucide-react'
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 w-full max-w-sm">
            ...
            <button
              ...
              className="w-full border border-zinc-700 hover:border-zinc-500 py-3 rounded-xl font-medium flex items-center justify-center gap-2 transition"
            >
